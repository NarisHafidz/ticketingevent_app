            ...
            <div class="lg:flex">
                ...
                <div class="card-body lg:w-2/3">
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <div class="text-sm text-gray-500">Qty: {{ $d->jumlah ?? 0 }}</div>
                            </div>
                            <div class="text-right">
                                <div class="font-bold">Rp {{ number_format($d->subtotal_harga ?? 0, 0, ',', '.') }}</div>
                            </div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-bold text-lg">Rp {{ number_format($order->total_harga ?? 0, 0, ',', '.') }}</span>
                    </div>
